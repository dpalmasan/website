...
Este año fue un punto de inflexión. Pasé de **E5 a E6**, un nivel que en muchos contextos se considera terminal, y asumí responsabilidades que me obligaron a replantear cómo genero impacto y qué significa realmente liderar desde lo técnico. No fue solo un cambio de nivel, sino de mentalidad: dejar de ser quien resuelve todo para convertirme en quien habilita que otros lo hagan.
...
Si llegaste hasta aquí, asegúrate de llegar hasta el final 😊.
...
Para mi sorpresa, este año en el "mid checkpoint" fue la primera vez que obtuve "SAE" (Significantly Above Expectations), que es una excelente señal para la evaluación de desempeño al final del año. Finalmente, tengo actualmente los resultados de dicha evaluación y obtuve _Greatly Exceeded Expectations_ y una promoción de `E5` a `E6` (dejo al lector la tarea de buscar qué significan los niveles 😂). Hasta ahora en Meta mi historia de _performance_:

<details>
<summary>Si quieres leer mi historial de ratings en evaluaciones de desempeño, <b>click aquí</b></summary>
...
Como me gustan los videojuegos, pensé, ¿por qué no aprender yo pixel art y generar mis propios assets? Dejo un poco de mi "portafolio" (aún llevo poco tiempo en esto)

El juego que estoy desarrollando se llama [The Ghost of The North](https://dpalmasan.itch.io/the-ghost-of-the-north), disponible en itch.io, jugable desde el navegador. Publicaré avances y `devlogs` del juego constantemente.
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin: 20px 0;">
  ...
  <div><img src="https://gist.githubusercontent.com/dpalmasan/103d61ae06cfd3e7dee7888b391c1792/raw/7f2f538c847ecc655c9ac52c8427bddf9d94528e/boss.png" alt="Boss" style="width: 100%; height: auto; display: block;"></div>
  ...
  <div><img src="https://gist.githubusercontent.com/dpalmasan/103d61ae06cfd3e7dee7888b391c1792/raw/7f2f538c847ecc655c9ac52c8427bddf9d94528e/load-screen.png" alt="Load Screen" style="width: 100%; height: auto; display: block;"></div>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span style="background-color: black; display: inline-block; padding: 5px;"><img src="https://gist.githubusercontent.com/dpalmasan/103d61ae06cfd3e7dee7888b391c1792/raw/ebcf320720c6e9cd075a33c9653a20923c2e415d/polar-bear-walking.gif" alt="Polar Bear Walking" style="display: block;"></span></td>
    </tr>
    <tr>
